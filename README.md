...
# → Produit les 5 graphiques + rapport console
```
...
Projet réalisé dans le cadre d'une préparation de candidature en tant que **Business Analyst Data Product [Luxe-Retail]**. Le cas est entièrement fictif mais construit sur des benchmarks sectoriels réels (taux de retour e-commerce, structure PIM Akeneo, réglementation DPP UE).

**Auteur :** Hajar Bougataya — Étudiante ingénieure en mathématiques appliquées & data science (CY Tech), apprentie Analytics Engineer (Nickel / BNP Paribas).
